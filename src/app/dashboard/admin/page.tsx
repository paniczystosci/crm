...
export default function AdminDashboard() {
  ...
  const statCards = [
    ...
    { label: 'Сегодня', value: stats.todayOrders, icon: TrendingUp, color: 'from-green-500 to-green-600', bgColor: 'bg-green-50 dark:bg-green-950/30' },
      ...
      <div className="max-w-7xl mx-auto p-4 md:p-6 lg:p-8">
        ...
        <div>
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
            <div className="h-1 w-8 bg-gradient-to-r from-rose-500 to-amber-500 rounded-full"></div>
            Быстрые действия
          </h2>
                  ...
                  <NeoCard>
                    <div className="flex justify-between items-center">
                      ...
                      <div className="relative">
                        ...
                        <div className="absolute -inset-2 bg-gradient-to-r from-rose-500 to-amber-500 rounded-full opacity-0 group-hover:opacity-20 blur-xl transition-opacity"></div>
                      </div>
                    </div>
                  </NeoCard>
                </div>
